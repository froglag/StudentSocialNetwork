...
public class Application : IApplication
{
    ...
    {
        await _sqlAccess.SaveData("dbo.spUser_Insert", new { user.FirstName, user.LastName, user.UniversityId, user.FacultyId, user.SpecializationId, user.Email, user.Image });
    }
